...
public class MulaMqtt {
    ...
    public static final String USERNAME = "admin";// 默认用户名
     ...
     * @return 通知栏id
     */
    public static int showNotification(Context context, Intent intent, String title, String message) {
        return IMNotification.getInstance(context).show(context, intent, title, message);
    }
